...
COMMANDS_LIST = {
    ...
    'редактура': ['!rewrite', '!fix'],
    'проверка': ['!factcheck', '!args', '!tr'],
}
...
HELP_CATS = {
    ...
    'ai': (
        ...
        "**Редактура (ИИ):**\n"
        "`!rewrite [стиль]` — переписать текст в заданном стиле\n"
        "`!fix [текст]` — грамматика и смена раскладки\n\n"
        "**Проверка (ИИ):**\n"
        "`!factcheck` — проверка фактов и нестыковок\n"
        "`!args` — 3 контраргумента для спора\n"
        "`!tr [код]` — перевод текста в Избранное\n\n"
        "**Медиа:**\n"
    ...
    'редактура': (
        "✏️ **РЕДАКТУРА (ИИ)**\n\n"
        "`!rewrite [стиль]` — переписать последний текст в выбранном стиле "
        "(вежливо, официально, токсично, гопник)\n"
        "`!fix [текст]` — исправить грамматику и переключить раскладку ENG/RU\n"
    ),
    'проверка': (
        "🔍 **ПРОВЕРКА (ИИ)**\n\n"
        "`!factcheck` — проверить факты и найти нестыковки\n"
        "`!args` — 3 контраргумента для спора\n"
        "`!tr [код]` — перевод текста в Избранное\n"
    ),
}
